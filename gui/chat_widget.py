...
class ChatWidget(QWidget):
    ...
    async def _process_call_loop(self) -> None:
        ...
        call_instruction = (
            ...
            "- NEVER end the call on your own. Only include [END_CALL] at the very end of your final response when the USER explicitly asks to end or says goodbye.\n"
            "- If the user seems done but hasn't explicitly asked to end, ask them before ending.\n"
